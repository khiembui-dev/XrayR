...
# (Nếu chưa có cert thật thì để CertMode: none)
# cat >"$CERT_PATH/node1.test.com.cert" ...
# cat >"$CERT_PATH/node1.test.com.key" ...
...
echo -e "\n✅ Đã hoàn tất cài đặt và cấu hình Node Trojan!"
